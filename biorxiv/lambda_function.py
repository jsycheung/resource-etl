...
def lambda_handler(event, context):
    """Lambda function to download data from biorxiv api, process data by filtering for keyword, and upload to s3 bucket."""
    ...
    while True:
        prev_date = get_prev_date(bucket_name, file_prefix, bookmark_filename, baseline_date)
        ...
        # Case where data is processed and uploaded to s3
            ...
            upload_s3(json.dumps(download_data_list).encode("utf-8"), bucket_name, f"{file_prefix}/{date_to_download}.json")
